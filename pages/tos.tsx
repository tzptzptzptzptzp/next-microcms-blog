...
export default function TOS() {
  return (
    <Transition>
      <NextHeadSeo
        {...MetaData}
        og={{ ...MetaData.og, title: `利用規約 | WEBのあれこれ` }}
        ...
        <div>
          <main className="mt-60 px-8 s:px-6 leading-loose s:leading-relaxed">
            <div className="w-[70%] s:w-full max-w-[1536px] m-auto">
              <h1 className=" mb-20 py-8 border-b-4 text-6xl text-center">
                ー 利用規約 ー
              </h1>
              <p>
                この利用規約（以下，「本規約」といいます。）は，
                <a href="../">WEBのあれこれ</a>
                （以下，「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
              </p>
              <h2>第1条（適用）</h2>
              <ol>
                <p className="mb-8">
